...
from relay_hub.pickup import load_pickup_state, pickup_context_seed_path, save_pickup_state
...
def build_codex_prompt(
    *,
    ...
    return (
        ...
        "2. 如果 branch 任务需要修改项目文件，就在绑定项目根目录内完成修改，并遵守项目里的 AGENTS.md / 开发日志规则。\n"
...
def run_codex_exec(project_root: str | None, prompt: str) -> tuple[str | None, str | None]:
...
def process_once(
    *,
    ...
    if backend == "codex-exec":
        body, error = run_codex_exec(project_root, prompt)
